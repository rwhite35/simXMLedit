...
$workpath = "admin".DIRECTORY_SEPARATOR."dashboard.php";
/* 
* USER CHECK --	
*/
...
<head>
<meta charset="UTF-8"/>
<title><?php echo strtoupper($_SESSION['staff']['parent'])." MANAGER"?></title>
...
<div id="row" name="content row">
	<div id="left" style="padding-left:2%">
		<h2 class="subhead">TEXT MANAGER FOR <?php echo strtoupper($_SESSION['staff']['parent'])?></h2>
		<iframe class="preview" src="<?php echo $workpath?>" width="85%" height="535px" frameBorder=0 border=0 seamless></iframe>
	</div><!--close left-->
<div id="right">
